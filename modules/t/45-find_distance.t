...
is( $d1, 17, 'Checking distance between taxons is as expected');

my $d2 = $node_adaptor->distance_between_nodes($node2, $node1);
is( $d2, 17, 'Checking distance between taxons in reverse is as expected');
...
is( $d1, 17, 'Checking distance between taxons is as expected using the object method');

$d2 = $node2->distance_to_node($node1);
is( $d2, 17, 'Checking distance between taxons in reverse is as expected using the object method');
